package com.poja.first.endpoint.rest.controller;

import static java.util.UUID.randomUUID;

import com.poja.first.PojaGenerated;
import com.poja.first.endpoint.event.EventProducer;
import com.poja.first.endpoint.event.gen.UuidCreated;
import com.poja.first.repository.DummyRepository;
import com.poja.first.repository.DummyUuidRepository;
import com.poja.first.repository.model.Dummy;
import com.poja.first.repository.model.DummyUuid;
